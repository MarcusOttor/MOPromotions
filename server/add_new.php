    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Добавить приложение</li>
        </ol>
  ...
  <!-- <div class="row">
       ...
       <div class="card mb-3">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
             <form enctype="multipart/form-data" method="post" action="add_new.php"> 
                 <input type="hidden" name="MAX_FILE_SIZE" value="10000000"/>
                <div class="form-group">
                  <label for="app_name">Название приложения</label>
                  <input type="text" class="form-control" required placeholder="Ведите название для приложения" name="app_name">
                </div>
                 <div class="form-group">
                  <label for="userfile">Загрузите картинку для приложения</label>
                  <input type="file" class="form-control" name="userfile">
                </div>
                 <div class="form-group">
                  <label for="package">Пакет приложения</label>
                  <input type="text" placeholder="Укажите пакет приложения" class="form-control" required name="app_package" aria-describedby="basic-addon2" style=" width: 100%;">
                </div>
                <div class="form-group">
                  <label for="priority">Приоритет</label>
                   <input type="number" class="form-control" name="priority" min="1" step="1" m max="10"required aria-describedby="basic-addon4" maxlength="2">
                </div>
                  <div class="form-group">
                  <label for="priority">Ключевые слова</label>
                   <input type="text" class="form-control" name="keywords" aria-describedby="basic-addon4">
                </div>
                 <div class="form-group">
                  <label for="priority">Цена в игровой валюте</label>
                   <input type="number" class="form-control" name="price" min="1" step="1" required aria-describedby="basic-addon4">
                </div>
                 
                <div class="form-group">
                </div>
                <button class="btn btn-success btn-block" type="submit" name="add_new">Добавить</button>
          </form>
          </div>
        </div>
