    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Все приложения</li>
        </ol>
              ...
              <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                    <?php foreach($list_apps as $key => $value){
                        ...
                        $fact_price = $value['price'] * $value['priority'] / 10;
                        ...
                        <div id="viewApp<?php echo $value['id']; ?>" class="modal fade text-dark">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <b>Картинка приложения:</b><br>
                                            <?php echo '<img style="height: 200px; width: 200px;" 
										src="data:image/jpeg;base64,'.base64_encode( $value['image']).'"/>'; ?>
                                        </div>
                                        <div class="modal-body">
                                            <b>Название пакета:</b>
